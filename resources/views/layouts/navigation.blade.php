<nav x-data="{ open: false }" class=" border-b border-gray-100 navegacion-nav">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('mision_vision')" :active="request()->routeIs('mision_vision')">
                        {{ __('Misión visión') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-900 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 name-yda">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('mision_vision')" :active="request()->routeIs('mision_vision')">
                {{ __('Misión visión') }}
            </x-responsive-nav-link>
